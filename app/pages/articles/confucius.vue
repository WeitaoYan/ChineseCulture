<template>
  <div class="content-page">
    ...
    <div class="page-header">
      <h1 class="page-title">Confucius &amp; Confucianism</h1>
      <p class="page-subtitle">
        Kǒng Zǐ - The Sage Who Shaped Chinese Civilization
      </p>
      <PageMeta>
        <MetaItem>📖 The Analects</MetaItem>
    ...
    <!-- 主图 -->
    <FeaturedImage
      imageSrc="/assets/images/confucius.png"
      altText="Statue of Confucius with temple architecture in traditional Chinese style"
    />
    ...
    <div class="content-body">
      ...
      <section class="section">
        ...
        <p class="section-text">
          <strong>Confucius</strong> (孔子, Kǒng Zǐ, 551–479 BCE) is the most
          influential philosopher in Chinese history. His teachings — known as
          <strong>Confucianism</strong> (儒家, Rú Jiā) — have shaped the moral
          framework, social structure, and political philosophy of East Asia for
          over 2,500 years. No single thinker has had a more profound and
          enduring impact on Chinese civilization.
        </p>
        <p class="section-text">
          Confucius was not a religious prophet but a moral philosopher and
          educator who believed that human virtue, proper relationships, and
          ethical governance could create a harmonious society. His philosophy
          emphasizes personal cultivation, respect for tradition, filial piety,
          and the power of education — values that remain deeply embedded in
      ...
      <!-- 孔子生平 -->
      <section class="section">
        <h2 class="section-title">The Life of Confucius</h2>
        <p class="section-text">
          Born in 551 BCE in the state of Lu (now Qufu, Shandong Province),
          Confucius came from a noble but impoverished family. He lost his
          father at age three and was raised by his mother, developing a deep
          appreciation for learning and ritual from an early age.
        </p>
        <FeatureGrid>
          ...
          <FeatureItem title="Teaching Career (532–501 BCE)" theme="red">
            <p>
              At 30, Confucius began his life's work: teaching. He broke with
              tradition by accepting students from all social classes, not just
              the aristocracy. His school taught the Six Arts: ritual, music,
              archery, charioteering, calligraphy, and mathematics.
            </p>
          </FeatureItem>
          <FeatureItem title="Political Service (501–497 BCE)" theme="blue">
            <p>
              Appointed Minister of Crime in Lu, Confucius implemented reforms
              that dramatically improved public order. However, political
              intrigue forced him into exile. He spent the next 13 years
              wandering from state to state, seeking a ruler who would put his
      ...
      <!-- 五伦 -->
      <section class="section">
        <h2 class="section-title">The Five Relationships (五伦 / Wǔ Lún)</h2>
        <p class="section-text">
          Confucian ethics is fundamentally relational. Society is built upon
          five key relationships, each with mutual duties and responsibilities:
        </p>
        <FeatureGrid>
      ...
      <!-- 四书五经 -->
      <section class="section">
        <h2 class="section-title">The Four Books & Five Classics (四书五经)</h2>
        <p class="section-text">
          Confucianism's canonical texts became the foundation of Chinese
          education for over 1,300 years. From the Song Dynasty onward, mastery
          of these texts was essential for success in the Imperial Examination
          system:
        </p>
      ...
      <!-- 历史传承 -->
      <section class="section">
        <h2 class="section-title">Legacy Through the Dynasties</h2>
        <FeatureGrid>
...
definePageMeta({
  ...
  ogTitle: "Confucius & Confucianism — The Philosophy That Built China",
  ogDescription:
    "Explore the life, teachings, and legacy of Confucius — the most influential philosopher in Chinese history",
  ogType: "article",
  ogImage: "/assets/images/confucius.png",
  twitterCard: "summary_large_image",
  twitterTitle: "Confucius & Confucianism",
  twitterDescription:
    "Explore the life, teachings, and legacy of Confucius — the most influential philosopher in Chinese history",
  robots: "index,follow",
});
...
useHead({
  ...
  title: "Confucius & Confucianism — The Sage Who Shaped China",
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        "@type": "Article",
        name: "Confucius & Confucianism",
        description:
          "Comprehensive guide to Confucius (Kongzi) and Confucian philosophy, covering his life, core teachings, the Five Constants, Four Books & Five Classics, and global influence",
      }),
    },
  ],
});
