<template>
  <div class="content-page">
    ...
    <div class="content-body">
      ...
      <!-- 历史渊源 -->
      <section class="section">
        <h2 class="section-title">A 1,800-Year History</h2>
        <p class="section-text">
          The abacus has a rich and ancient history, evolving alongside China's
          economic and intellectual development:
        </p>
        <FeatureGrid>
          <FeatureItem title="Han Dynasty Origins (2nd Century)" theme="gold">
            <p>
              The earliest known depiction of an abacus-like device appears in a
              Han Dynasty (206 BCE – 220 CE) mural. Early counting rods (算筹)
              gradually evolved into a framed bead calculator, laying the
          ...
          <FeatureItem title="Song Dynasty Standardization (960–1279)" theme="red">
            <p>
              ...
              Zhang Zeduan depicts an abacus in a pharmacy, showing its
              integration into daily commercial life.
            </p>
          </FeatureItem>
      ...
      <!-- 珠算的构造 -->
      <section class="section">
        <h2 class="section-title">The Anatomy of the Suanpan</h2>
        <p class="section-text">
          The Chinese abacus differs from its Japanese (soroban) and Russian
          (schoty) counterparts in a key way — the classic 2/5 bead arrangement:
        </p>
        <FeatureGrid>
          <FeatureItem title="Heaven Beads (上珠)" theme="gold">
            <p>
              Each column has two beads in the upper deck. Each heaven bead
              represents a value of 5. The beads are pushed toward the beam (the
              central divider) to count — beads away from the beam represent
              zero.
            </p>
          </FeatureItem>
          <FeatureItem title="Earth Beads (下珠)" theme="blue">
            <p>
              Each column has five beads in the lower deck. Each earth bead
              represents a value of 1. The classic 2/5 configuration allows
              decimal and hexadecimal calculations — particularly useful for
              traditional Chinese weights and measures.
            </p>
          </FeatureItem>
          <FeatureItem title="The Beam (梁)" theme="red">
            <p>
              The horizontal divider separates the heaven and earth decks. Beads
              are counted only when they touch the beam — this creates a clear
              visual representation of numerical values at a glance, making the
              abacus a remarkably intuitive device.
            </p>
          </FeatureItem>
          <FeatureItem title="The Frame (框)" theme="gold">
            <p>
      ...
      <section class="section">
        ...
        <FeatureGrid>
          <FeatureItem title="The Speed of Thought" theme="red">
            <p>
              Masters of mental abacus can add 15-digit numbers in seconds,
              performing calculations faster than most people can type them into
              a calculator. This is achieved through years of training that
              builds a vivid, highly structured mental model of the abacus.
            </p>
          </FeatureItem>
          ...
          <FeatureItem title="Finger Movements (指法)" theme="blue">
            <p>
      ...
      <!-- 文化意义 -->
      <section class="section">
        <h2 class="section-title">Cultural and Philosophical Significance</h2>
        <p class="section-text">
          The abacus is more than a calculating tool — it is a cultural symbol
          deeply embedded in Chinese life and philosophy:
        </p>
        <FeatureGrid>
          <FeatureItem title="Prosperity Symbol" theme="gold">
            <p>
              The abacus is one of the Eight Treasures of Chinese auspicious
              symbols, representing wealth and financial wisdom. Miniature
              abacus charms are carried as good luck talismans for business
              success, and abacus imagery appears in Feng Shui and New Year
              decorations.
            </p>
          </FeatureItem>
          ...
          <FeatureItem title="Harmony of Mind and Hand" theme="blue">
            <p>
          ...
          <FeatureItem title="Language and Idioms" theme="gold">
            <p>
              The abacus has left its mark on the Chinese language. Phrases like
              "打如意算盘" (dǎ rúyì suànpán — "wishful thinking," literally
              "playing the wishful abacus") and "小算盘" (xiǎo suànpán — "petty
              calculations") reflect how deeply the abacus is woven into daily
              speech.
            </p>
          </FeatureItem>
        </FeatureGrid>
        ...
        <FeatureGrid>
          <FeatureItem title="School Curriculum" theme="red">
            <p>
              ...
              and those struggling with math anxiety.
            </p>
          </FeatureItem>
          <FeatureItem title="Digital Era" theme="gold">
            <p>
              ...
              hexadecimal systems in computer science.
            </p>
          </FeatureItem>
